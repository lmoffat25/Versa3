...
function fitbit_scripts() {
	...
	wp_enqueue_script( 'flikity', get_template_directory_uri() . '/js/libraries/flickity.min.js', array(), '2.0', true);
...
function cptui_register_my_cpts()
{
    ...
    $labels = [
        "name" => __("Cartes", "fitbit"),
        "singular_name" => __("Carte", "fitbit"),
    ];

    $args = [
        "label" => __("Cartes", "fitbit"),
        "labels" => $labels,
        "description" => "",
        "public" => true,
    ...
    /**
     * Post Type: Fonctionnalités.
     */

    $labels = [
        "name" => __("Fonctionnalités", "fitbit"),
        "singular_name" => __("Fonctionnalité", "fitbit"),
    ];

    $args = [
        "label" => __("Fonctionnalités", "fitbit"),
        "labels" => $labels,
        "description" => "",
        "public" => true,
        "publicly_queryable" => true,
        ...
        "map_meta_cap" => true,
        "hierarchical" => false,
        "rewrite" => ["slug" => "functionalities", "with_front" => true],
        "query_var" => true,
        "menu_icon" => "dashicons-admin-generic",
        "supports" => ["title", "editor", "thumbnail"],
    ];

    register_post_type("functionalities", $args);
    ...
    $labels = [
        "name" => __("A propos", "fitbit"),
        "singular_name" => __("A propos", "fitbit"),
    ];

    $args = [
        "label" => __("A propos", "fitbit"),
        "labels" => $labels,
        "description" => "",
        "public" => true,
        "publicly_queryable" => true,
    ...
    $labels = [
        "name" => __("Slides", "fitbit"),
        "singular_name" => __("Slide", "fitbit"),
    ];

    $args = [
        "label" => __("Slides", "fitbit"),
        "labels" => $labels,
        "description" => "",
        "public" => true,
        "publicly_queryable" => true,
    ...
    $labels = [
        "name" => __( "Conseils", "fitbit" ),
        "singular_name" => __( "Conseil", "fitbit" ),
    ];

    $args = [
        "label" => __( "Conseils", "fitbit" ),
        "labels" => $labels,
        "description" => "",
        "public" => true,
        "publicly_queryable" => true,
        ...
        "map_meta_cap" => true,
        "hierarchical" => false,
        "rewrite" => [ "slug" => "conseils", "with_front" => true ],
        "query_var" => true,
        "supports" => [ "title", "editor", "thumbnail" ],
    ];
